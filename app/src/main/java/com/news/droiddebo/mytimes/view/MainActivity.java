...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private final String[] SOURCE_ARRAY = {"google-news-in", "bbc-news", "the-hindu", "the-times-of-india",
...
//                .withIcon(R.drawable.ic_code).withTypeface(montserrat_regular);
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(item0, item1, item2, item3, item4, item5, item6, item7, item8, item9,
                        ...
                        item20, item21, item22, item23, item24, item25, item26, item27, item29, item30)
    ...
    **/
    ...
    private void sendEmail() {
        ...
        emailIntent.setData(Uri.parse("mailto: muskanchhabria2002@gmail.com"));
